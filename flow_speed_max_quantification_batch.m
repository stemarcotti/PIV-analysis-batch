...
for file_list = 1:n_files
    ...
    [flow_speed_max, flow_speed_max_average] = max_flow_quantification(directory, file, d, cell_ID);
    
    % save [flow_speed]: mean flow velocity for each frame [um/min]
    save(fullfile(directory, ...
        ['flow_speed_max_', output_name, '.mat']), ...
        'flow_speed_max');
    
    % save [flow_speed_average]: mean flow velocity averaged for all frames [um/min]
    save(fullfile(directory, ...
        ['flow_speed_max_average_', output_name, '.mat']), ...
        'flow_speed_max_average');
    
    % clear output variables
    clear flow_speed_max flow_speed_max_average
